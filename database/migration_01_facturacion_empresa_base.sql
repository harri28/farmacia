-- ============================================================
-- ARCHIVO: farmacia/database/migration_01_facturacion_empresa_base.sql
-- DESCRIPCION: Paso 1 - datos base de empresa para facturacion.
-- USO:
--   psql -U postgres -d farmacia -f database/migration_01_facturacion_empresa_base.sql
-- ============================================================

...
$db     = getDB();
$sql    = file_get_contents(__DIR__ . '/migration_fecha_vencimiento.sql');
$sql    = preg_replace('/--[^\n]*/', '', $sql);
$errors = [];
$ok     = [];
...
<!DOCTYPE html>
<html lang="es">
<head><meta charset="UTF-8"><title>Migración Fecha de Vencimiento</title>
...
<h2>Migración: Fecha de Vencimiento en Productos</h2>
...
<p><a href="../modules/inventario/index.php">← Ir al Inventario</a></p>
</body></html>
